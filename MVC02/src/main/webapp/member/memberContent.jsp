...
<%
    ...
    MemberVO vo = dao.memberContent(parameter);
%>
<!DOCTYPE html>
<html>
<head>
...
<script src="/MVC02/js/script.js"></script>
<title>MemberContent</title>
</head>
<body>
<h2><%= vo.getName() %>의 Profile</h2>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="8" align="right">
                ...
                <input type="button" value="돌아가기" onclick="location.href='memberList.jsp'" class="btn btn-success"/>
            </td>
        </tr>
    </tbody>
    <%
