...
//                                                                     ?-> (파라메터)1  2  3  4  5  6
//        String SQL = "insert into member(id, pass, name, age, email, phone) values(?, ?, ?, ?, ?, ?)"; -> Mysql query
        String SQL = "INSERT INTO member(num, id, pass, name, age, email, phone) VALUES(member_seq.nextval, ?, ?, ?, ?, ?, ?)"; // Oracle query
